...
namespace QuanLyThuVien
{
    public partial class TrangChu : Form
    {
        ...
        {
            if (txtMaNV.Text.Trim() == "" || txtTenNV.Text.Trim() == "" || txtSoDienThoai.Text.Trim() == "" || cbGioiTinh.Text.Trim() == "" || txtDiaChi.Text.Trim() == "" || txtMatKhau.Text.Trim() == "" || cbPer.Text == "")
            {
            ...
            string checkPhoneQuery = "SELECT COUNT(*) FROM NhanVien WHERE SoDienThoai = @SoDienThoai";
            mySqlCommand = new SqlCommand(checkPhoneQuery, mySqlconnection);
            mySqlCommand.Parameters.AddWithValue("@SoDienThoai", txtSoDienThoai.Text);
            int phoneCount = Convert.ToInt32(mySqlCommand.ExecuteScalar());
            ...
            string query1 = "insert into NhanVien(MaNhanVien, TenNhanVien, SoDienThoai, GioiTinh, DiaChi, MatKhau, Quyen) values(N'" + txtMaNV.Text + "',N'" + txtTenNV.Text + "','" + txtSoDienThoai.Text + "', N'" + cbGioiTinh.Text + "', N'" + txtDiaChi.Text + "',  N'" + txtMatKhau.Text + "', N'" + cbPer.Text + "')";
            mySqlCommand = new SqlCommand(query1, mySqlconnection);
            mySqlCommand.ExecuteNonQuery();
            NhanVien();
